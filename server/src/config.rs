...
make_config! {
    ...
    settings {
        ...
        /// Invitation token expiration time (in hours) |> The number of hours after which an organization invite token,
        ...
        /// Invitation organization name |> Name shown in the invitation emails
